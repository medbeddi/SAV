<template>
  <div class="container">
    <div class="card">
      <h1 class="card_title">Ajouter un Technicien</h1>
      <form class="card_form" @submit.prevent="createTechnicien">
        <div class="input">
          <input type="text" class="input_field" v-model="technicien.nom" required />
          <label class="input_label">Nom</label>
        </div>

        <div class="input">
          <input type="text" class="input_field" v-model="technicien.specialisation" required />
          <label class="input_label">Spécialisation</label>
        </div>

        <button type="submit" class="card_button">Créer Technicien</button>
      </form>
    </div>
